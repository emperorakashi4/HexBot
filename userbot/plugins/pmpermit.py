...
BAALAJI_TG_USER_BOT = "`I Haven't Approved You To PM! Don't Spam!`"
TG_COMPANION_USER_BOT = "`Please Wait For My Response And Don't Spam.`"
UNIBORG_USER_BOT_WARN_ZERO = "`I Am Currently Offline! Please Don't Spam.`"
UNIBORG_USER_BOT_NO_WARN = "`Hi! I Will Respond Soon. Leave Your Message And Don't Spam!`"
